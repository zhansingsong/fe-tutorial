...
export default class HyperList {
  ...
  constructor (element, userProvidedConfig) {
    ...
    const render = () => {
      ...
      console.log('diff: scrollTop - lastRepaint', scrollTop - lastRepaint)
      console.log('scrollTop: ', scrollTop)
      console.log('diff: ', diff)
      console.log('!lastRepaint || diff < 0 || diff > this._averageHeight ', lastRepaint, this._averageHeight)
  ...
  // 合并config，验证配置项，挂载element，实例化items height
